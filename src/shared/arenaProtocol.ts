...
export type ArenaSnapshot = {players:ArenaPlayer[];stack:ArenaCard[];combat:ArenaCombat[];phase:string;activePlayerId:string|null;gameOver:boolean;lastEventSequence:number;gameNumber?:number;bestOf?:1|3;scores?:number[];matchOver?:boolean;coinWinnerSeat?:number|null;coinChoicePending?:boolean};
